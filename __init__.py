...
class REGONAPI(object):
    ...
    # Zmiana wprowadzona przez Jagiego - dodana funkcja raport_pkd, ktora prawidlowo zwraca liste pkdow jakimi zajmuje sie firma
    
    def raport_pkd(self, regon, report_name = 'PublDaneRaportDzialalnosciPrawnej'):
        mesg = self.call(
            FULL_REPORT_ENVELOPE,
            regon = regon,
            report_name = report_name
        ...
        return [each.getchildren() for each in result[0].getchildren()] 
